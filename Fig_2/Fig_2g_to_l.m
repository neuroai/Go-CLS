% code for Student-Teacher-Notebook framework, Fig.2g-l, analytical curves
...
% figure(3)
% set(gcf,'position',[100,100,350,290])
% saveas(gcf,strcat('Fig_2i','.pdf'));
% figure(4)
% set(gcf,'position',[100,100,350,290])
% saveas(gcf,strcat('Fig_2j','.pdf'));
% figure(5)
% set(gcf,'position',[100,100,350,290])
% saveas(gcf,strcat('Fig_2k','.pdf'));
% figure(6)
% set(gcf,'position',[100,100,350,290])
% saveas(gcf,strcat('Fig_2l','.pdf'));
