%Supplemental Fig.2: Generalization and memorization performance as a
...
colorbar
set(gcf,'position',[500 500 440 325])
saveas(gcf,'Supp_fig_1d.pdf');



%save('batch_curves_lr_0d01_040621.mat','Et_no_ES','Eg_no_ES','Et_ES','Eg_ES','SNR_log_interval','SNR_vec','alpha_vec')
